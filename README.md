# λ ((M))  
#### A Lisp-1 like language that emphasizes transparency and extensibility; The core of the language excluding Stdlib is only about 1600 lines of structured self documenting code; Using nothing but the Nim standard library Besides `BigInts`
